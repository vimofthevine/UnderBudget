...
/**
 * Unit test case for the SpecificEstimateBehavior class.
 * 
 * @author Kyle Treubig <kyle@vimofthevine.com>
 */
public class SpecificEstimateBehaviorTest {

	/**
	 * Specific estimate behavior
	 */
	SpecificEstimateBehavior behavior;
	...
	{
		behavior = new SpecificEstimateBehavior();
	...
	/**
	 * Verifies that specific estimates report
	...
	/**
	 * Verifies that specific estimates report do
	 * not report as under-budget if the estimated
	...
	/**
	 * Verifies that specific estimates do not
