...
class LedgerRepositoryTest : TestFixture() {
    @Test fun `should create ledger`() = withDatabase {
        val id = createLedger(Ledger(id = null, name = "test ledger", defaultCurrency = "UAH"))
    ...
    @Test fun `should create ledger permission`() = withDatabase {
        val id = createLedger(Ledger(id = null, name = "ledger 1", defaultCurrency = "USD"))
    ...
    @Test fun `should find all ledgers for which user has permission`() = withDatabase {
        val id1 = createLedger(Ledger(id = null, name = "ledger 1", defaultCurrency = "USD"))
        val id2 = createLedger(Ledger(id = null, name = "ledger 2", defaultCurrency = "UAH"))
