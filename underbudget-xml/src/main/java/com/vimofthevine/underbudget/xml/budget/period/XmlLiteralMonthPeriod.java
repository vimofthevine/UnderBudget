...
MonthlyBudgetingPeriod {
	 ...
	 */
	@Attribute(name="type")
	static final String TYPE = "literal-month";
	
	/**
	 * Original literal month period wrapped by this object
	 */
	private final LiteralMonthPeriod original;
	...
	/**
	 * Constructs a new XML serializable literal
	 * month period wrapper around the given
	 * literal month period.
	 * 
	 * @param period original literal month period
	 */
	public XmlLiteralMonthPeriod(LiteralMonthPeriod period)
	{
		original = period;
