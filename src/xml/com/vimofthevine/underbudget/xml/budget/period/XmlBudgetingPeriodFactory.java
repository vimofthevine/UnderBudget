...
/**
 * Factory for creating the appropriate wrapper
 * for a given budgeting period.
 * 
 * @author Kyle Treubig <kyle@vimofthevine.com>
 */
public abstract class XmlBudgetingPeriodFactory {

	
	public static XmlBudgetingPeriod create(BudgetingPeriod original)
	{
		if (original instanceof XmlBudgetingPeriod)
			...
			return new XmlLiteralMonthPeriod((LiteralMonthPeriod) original);
		else
