...
void MainWindow::createActions()
{
	...
	saveAsAction = new QAction(QIcon(":/icons/saveAs.png"), tr("Save &As..."), this);
	saveAsAction->setShortcuts(QKeySequence::SaveAs);
	saveAsAction->setStatusTip(tr("Save as a new budget"));
	connect(saveAsAction, SIGNAL(triggered()), this, SLOT(notImpl()));

	saveAsTemplateAction = new QAction(QIcon(":/icons/saveAsTemplate.png"), tr("Save As &Template..."), this);
	...
	exportAction = new QAction(QIcon(":/icons/export.png"), tr("&Export..."), this);
	...
	closeAction = new QAction(QIcon(":/icons/close.png"), tr("&Close"), this);
	closeAction->setShortcuts(QKeySequence::Close);
	closeAction->setStatusTip(tr("Close the budget"));
	connect(closeAction, SIGNAL(triggered()), this, SLOT(notImpl()));

	closeAllAction = new QAction(QIcon(":/icons/closeAll.png"), tr("Close A&ll"), this);
	...
	// Edit menu actions
	editBudgetAction = new QAction(QIcon(":/icons/editBudget.png"), tr("&Budget"), this);
	...
	editEstimatesAction = new QAction(QIcon(":/icons/editEstimates.png"), tr("&Estimates"), this);
	...
	editRulesAction = new QAction(QIcon(":/icons/editRules.png"), tr("Assignment &Rules"), this);
	...
	editPrefsAction = new QAction(QIcon(":/icons/editPrefs.png"), tr("&Preferences"), this);
	...
	importAction = new QAction(QIcon(":/icons/import.png"), tr("&Import transactions..."), this);
	...
	importFromAction = new QAction(QIcon(":/icons/importFrom.png"), tr("Import transactions &from..."), this);
	...
	assignAction = new QAction(QIcon(":/icons/assign.png"), tr("&Assign transactions"), this);
	...
	calculateAction = new QAction(QIcon(":/icons/calculate.png"), tr("&Calculate balances"), this);
	...
	summaryAction = new QAction(QIcon(":/icons/summary.png"), tr("Anal&ysis summary"), this);
	...
	progressAction = new QAction(QIcon(":/icons/progress.png"), tr("Estimate &progress"), this);
	...
	impactAction = new QAction(QIcon(":/icons/impact.png"), tr("&Balance impact"), this);
	...
	transactionsAction = new QAction(QIcon(":/icons/transactions.png"), tr("Impor&ted transactions"), this);
	...
	aboutQtAction = new QAction(QIcon(":/icons/aboutQt.png"), tr("About &Qt"), this);
