...
public:
	/**
	 * Constructs a new condition operator delegate.
	 *
	 * @param[in] parent parent object
	 */
	ConditionOperatorDelegate(QObject* parent = 0);
	...
	/**
	 * Reimplemented to update the QComboBox with the current operator selection.
	 */
	void setEditorData(QWidget* editor, const QModelIndex& index) const;

	/**
	 * Reimplemented to apply the selected operator to the condition.
	 */
