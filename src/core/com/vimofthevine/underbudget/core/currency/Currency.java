...
public interface Currency extends Comparable<Currency> {
	 ...
	 * 
	 * @return inverted copy of this currency amount
	 */
	 ...
	 * @todo alter behavior so currency instances can be immutable
	 */
	 ...
	 * currency amount. This value is suitable
	 * for use in the constructor of currency objects.
	 * 
	 * @return string representation of the currency value
	 */
	public String toStr();
