...
public interface TransactionAssignments {
	...
	/**
	 * Records the assignment of the given transaction
	 * by the given assignment rule.
	 * 
	 * @param transaction transaction that has been assigned
	 * @param rule        assignment rule that assigned the transaction
	 */
	public void assign(Transaction transaction, AssignmentRule rule);
