...
/**
 * Defines the behavior of a specific estimate, that is an estimate
 * with a few, discrete specific expected transactions.
 * 
 * @author Kyle Treubig <kyle@vimofthevine.com>
 */
public class SpecificEstimateBehavior implements EstimateBehavior {
	
	/**
	 * Behavior type identifier
	 */
	@Attribute(name="type")
	public static final String TYPE = "specific";
	
	@Override
    public void report(DisplayableEstimate estimate, Currency estimated, Currency actual,
        EstimateProgressReport report)
    {
		// If actual is greater than estimated
	...
	{
		if (obj instanceof SpecificEstimateBehavior)
			return true;
		else
			return false;
	}
