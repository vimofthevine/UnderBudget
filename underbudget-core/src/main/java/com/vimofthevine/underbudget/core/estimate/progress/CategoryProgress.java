...
/**
 * Estimate progress for category estimates.
 * 
 * @author Kyle Treubig <kyle@vimofthevine.com>
 */
public class CategoryProgress implements EstimateProgress {
	...
	/**
	 * Constructs a new category estimate progress.
	 * 
	 * @param estimated estimated amount
	 * @param actual    actual amount
	 */
	public CategoryProgress(CashCommodity estimated, CashCommodity actual)
	{
