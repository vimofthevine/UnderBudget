...
/**
 * Estiamte progress for transfer estimates.
 * 
 * @author Kyle Treubig <kyle@vimofthevine.com>
 */
public class TransferProgress implements EstimateProgress {
	...
	/**
	 * Constructs a new transfer estimate progress.
	 * 
	 ...
	 */
	public TransferProgress(CashCommodity estimated, CashCommodity actual,
		SimpleDate due)
	{
