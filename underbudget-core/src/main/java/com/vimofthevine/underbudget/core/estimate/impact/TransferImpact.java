...
/**
 * Balance impact for transfer estimates.
 * 
...
public class TransferImpact implements BalanceImpact {
	...
	/**
	 * Constructs a new transfer balance impact.
	 * 
	 * @param estimated estimated amount
	 * @param actual    actual amount
	 */
	public TransferImpact(CashCommodity estimated, CashCommodity actual)
	{
		zero = Commodity.zero(estimated.getCurrency());
	}
